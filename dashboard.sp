...
SELECT
  ...
  azure_lb.tags ->> 'Baseline_Configuration' as "Baseline Configuration Name",
  '' as "OS Name and Version",
...
select
  ...
  azure_nat_gateway.tags ->> 'Baseline_Configuration' as "Baseline Configuration Name",
  '' as "OS Name and Version",
